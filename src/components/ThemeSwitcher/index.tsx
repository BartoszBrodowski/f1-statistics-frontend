  ...
  return (
    <form>
      <div className="flex items-center">
        ...
        <Switch.Root
          className="w-[42px] h-[25px] bg-blackA7 dark:bg-white rounded-full relative shadow-[0_2px_10px] shadow-blackA7 data-[state=checked]:bg-black outline-none hover:cursor-pointer"
